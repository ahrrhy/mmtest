...
function gallery_metabox_enqueue($hook) {
    if ( 'post.php' == $hook || 'post-new.php' == $hook ) {
        wp_enqueue_script(
            'gallery-metabox',
            get_template_directory_uri() . '/js/gallery-metabox.js',
            array('jquery', 'jquery-ui-sortable')
        );
        wp_enqueue_style(
            'gallery-metabox',
            get_template_directory_uri() . '/inc/gallery-metabox.css'
        );
    }
}
...
function gallery_meta_callback($post) {
    ...
    ?>
    <p><?php echo __('Слайды нужно добавлять с нормальными именами, их имена будут выводится как названия', 'boats' ); ?></p>
    <table class="form-table">
        <tr><td>
                ...
                ><?php echo __('Добавить слайд', 'boats'); ?></a>
                ...
                <ul id="gallery-metabox-list">
                    <?php if ($ids) : foreach ($ids as $key => $value) : $image = wp_get_attachment_image_src($value); ?>
                        <li>
                            ...
                            <a class="change-image button button-small"
                               href="#"
                               data-uploader-title="Change image"
                               data-uploader-button-text="Change image"
                            ><?php echo __('Поменять слайд', 'boats'); ?></a>
                            <small><a class="remove-image" href="#"><?php echo __('Удалить слайд', 'boats'); ?></a></small>
                        </li>
